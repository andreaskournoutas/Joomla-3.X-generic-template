...
<html lang="el" dir="<?php echo $this->direction; ?>">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/css/utilities.css?v=<?php echo $cache; ?>"/>
	...
	<body class="<?php echo $class ?>">
		...
		<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/js/template.js?v=<?php echo $cache; ?>"></script>
	</body>
</html>